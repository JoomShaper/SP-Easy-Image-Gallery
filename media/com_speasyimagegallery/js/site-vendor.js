          ...
          ((this.items = a(d).closest(c.parent).find(d.nodeName)),
            ...
            (this.init = function () {
              ...
              (this.navNext.on("click", function (a) {
                ...
                a(document).on(
                  "click",
                  ".speasyimagegallery-modal-wrapper, .speasyimagegallery-close",
                  function (a) {
                    a.target === this && (a.preventDefault(), b.close());
                  },
                ),
                a(document).on("keyup", function (a) {
                  (39 == a.keyCode && (a.preventDefault(), b.next()),
                    37 == a.keyCode && (a.preventDefault(), b.prev()),
                    27 == a.keyCode && (a.preventDefault(), b.close()));
                }),
                ...
                a(window).on("resize", function () {
                  var c = b.resize();
                  a(".speasyimagegallery-modal").css({
                    width: c.width,
                    height: c.height,
                  });
                }));
            ...
            (this.close = function () {
              ((this.index = 0),
                ...
                a(".speasyimagegallery-modal").animate(
                  { width: 100, height: 100 },
                  300,
                  function () {
                    (a(this).remove(),
                      a("body").removeClass("speasyimagegallery-modal-open"));
                  },
                ));
            }),
            ...
            (this.goto = function (b) {
              if (this.loaded === !1) {
                var d = this,
                  e = a(this.items[b]);
                ((d.loaded = !0),
                  a(".speasyimagegallery-modal-body").html(
                ...
                var f = a("<img />")
                  ...
                  .on("load", function () {
                    if (
                      this.complete &&
                      "undefined" != typeof this.naturalWidth &&
                      0 != this.naturalWidth
                    ) {
                      ((d.naturalWidth = this.naturalWidth),
                        (d.naturalHeight = this.naturalHeight));
                      var b = d.resize();
                      a(".speasyimagegallery-modal").animate(
                        ...
                        function () {
                          var b =
                            '<div class="speasyimagegallery-image-wrapper">';
                          ((b +=
                            ...
                            (c.showCounter ||
                              ...
                              (c.showDescription && e.attr("data-desc"))) &&
                              (e.attr("data-title") ||
                                e.attr("data-description")) &&
                              ((b +=
                                '<div class="speasyimagegallery-image-content">'),
                              c.showCounter &&
                                (b +=
                                  '<span class="speasyimagegallery-gallery-stat">' +
                                  (d.index + 1) +
                                  " of " +
                                  (d.count + 1) +
                                  "</span>"),
                              c.showTitle &&
                                e.attr("data-title") &&
                                (b +=
                                  '<span class="speasyimagegallery-image-title">' +
                                  e.attr("data-title") +
                                  "</span>"),
                              c.showDescription &&
                                e.attr("data-desc") &&
                                (b +=
                                  '<div class="speasyimagegallery-image-description">' +
                                  e.attr("data-desc") +
                                  "</div>"),
                              (b += "</div>")),
                            (b += "</div>"),
                            ...
                            d.modal
                              .find(".speasyimagegallery-hidden")
                              .removeClass("speasyimagegallery-hidden"),
                            (d.loaded = !1));
                        },
                      );
                    } else;
